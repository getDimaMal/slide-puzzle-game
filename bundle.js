...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _model_PuzzleModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/PuzzleModel */ \"./src/model/PuzzleModel.ts\");\n/* harmony import */ var _ui_Board__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ui/Board */ \"./src/ui/Board/index.ts\");\n/* harmony import */ var _ui_Tile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ui/Tile */ \"./src/ui/Tile/index.ts\");\n/* harmony import */ var _styles_main_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./styles/main.scss */ \"./src/styles/main.scss\");\n\n\n\n\ndocument.addEventListener('DOMContentLoaded', function () {\n    var root = document.getElementById('root');\n    if (!root)\n        throw new Error('Root container not found');\n    var size = 4;\n    var board = new _ui_Board__WEBPACK_IMPORTED_MODULE_1__[\"default\"]({ size: size }).render();\n    var puzzleModel = new _model_PuzzleModel__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({ size: size });\n    for (var _i = 0, _a = puzzleModel.getBoard(); _i < _a.length; _i++) {\n        var row = _a[_i];\n        for (var _b = 0, row_1 = row; _b < row_1.length; _b++) {\n            var value = row_1[_b];\n            var tile = new _ui_Tile__WEBPACK_IMPORTED_MODULE_2__[\"default\"]({ value: value }).render();\n            board.append(tile);\n        }\n    }\n    root.append(board);\n});\n\n\n//# sourceURL=webpack://slide-puzzle-game/./src/index.ts?");

/***/ }),

/***/ "./src/model/PuzzleModel.ts":
/*!**********************************!*\
  !*** ./src/model/PuzzleModel.ts ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar PuzzleModel = /** @class */ (function () {\n    function PuzzleModel(props) {\n        this.props = props;\n        this.board = this.generateBoard();\n    }\n    PuzzleModel.prototype.generateBoard = function () {\n        var size = this.props.size;\n        var board = Array.from({ length: size }, function (_, row) {\n            return Array.from({ length: size }, function (_, col) { return row * size + col + 1; });\n        });\n        board[size - 1][size - 1] = 0;\n        return board;\n    };\n    PuzzleModel.prototype.getBoard = function () {\n        return this.board;\n    };\n    PuzzleModel.prototype.setBoard = function (newBoard) {\n        this.board = newBoard;\n    };\n    return PuzzleModel;\n}());\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PuzzleModel);\n\n\n//# sourceURL=webpack://slide-puzzle-game/./src/model/PuzzleModel.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _tile_module_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tile.module.scss */ \"./src/ui/Tile/tile.module.scss\");\n\nvar Tile = /** @class */ (function () {\n    function Tile(props) {\n        this.props = props;\n        var value = this.props.value;\n        this.element = document.createElement('div');\n        this.element.append(value ? value.toString() : '');\n        this.element.classList.add(_tile_module_scss__WEBPACK_IMPORTED_MODULE_0__.tile);\n    }\n    Tile.prototype.render = function () {\n        return this.element;\n    };\n    return Tile;\n}());\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Tile);\n\n\n//# sourceURL=webpack://slide-puzzle-game/./src/ui/Tile/Tile.ts?");
